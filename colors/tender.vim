...
hi Folded guifg=#2c2c2c ctermfg=236 guibg=#202020 ctermbg=234 gui=NONE cterm=NONE
...
hi LineNr guifg=#3b3b3b ctermfg=237 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi MatchParen guifg=#f06c75 ctermfg=204 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
hi NonText guifg=#3b3b3b ctermfg=237 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi SpecialKey guifg=#3b3b3b ctermfg=237 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StatusLineNC guifg=#999999 ctermfg=246 guibg=#3b3b3b ctermbg=237 gui=NONE cterm=NONE
hi TabLine guifg=#999999 ctermfg=246 guibg=#3b3b3b ctermbg=237 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE ctermfg=NONE guibg=#3b3b3b ctermbg=237 gui=NONE cterm=NONE
...
hi Comment guifg=#2c2c2c ctermfg=236 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Boolean guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Number guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Float guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi CocWarningSign guifg=#9fafd9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocHintSign guifg=#7eceee ctermfg=117 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocInfoSign guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi cssIncludeKeyword guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi FugitiveblameNotCommittedYet guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi gitcommitUntrackedFile guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi helpSectionDelim guifg=#2c2c2c ctermfg=236 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi javaScriptNull guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsonEscape guifg=#7eceee ctermfg=117 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsonNumber guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsonBraces guifg=#eeeeee ctermfg=255 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsonNull guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsonBoolean guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownListMarker guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownBlockquote guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownUrlTitle guifg=#9fafd9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownUrlDelimiter guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownUrlTitleDelimiter guifg=#9fa1d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownCodeDelimiter guifg=#7eceee ctermfg=117 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownCode guifg=#9fafd9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi NERDTreeHelpCommand guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi NERDTreeClosable guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi pugJavascriptOutputChar guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi typescriptCall guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi typescriptArrowFuncArg guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi typescriptParamImpl guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi typescriptMemberOptionality guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi typescriptOptionalMark guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi javaScriptFuncArg guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi jsNull guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi jsFuncArgs guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsSpecial guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi plugNumber guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi plugDash guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi plugStar guifg=#9fafd9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi plugMessage guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi plugSha guifg=#9fafd9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi stylusImport guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi vimCommentString guifg=#9fa1d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi xmlNamespace guifg=#9fb0d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi javascriptDocParamName guifg=#9fa1d9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi yamlFlowString guifg=#9fafd9 ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
